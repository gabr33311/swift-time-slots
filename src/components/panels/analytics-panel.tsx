      ...
      {isLoading ? (
        ...
        <>
          <div className="grid grid-cols-2 gap-3 lg:grid-cols-3">
            <StatCard label="Visualizações da página" value={views} />
            <StatCard label="Marcações recebidas" value={bookings} />
            <StatCard label="Taxa de conversão" value={`${conversion.toFixed(1)}%`} />
          </div>

          <section className="surface mt-4 p-5">
            <div className="flex items-center justify-between text-sm font-bold">
              <span>Visitas que marcaram</span>
          ...
          <div className="mt-4 grid grid-cols-2 gap-3 lg:grid-cols-4">
            <StatCard label="Concluídas" value={done.length} />
